...
const ReadingListSection = (props: {
	title: string
	filteredBookmarks: ReadingListBookmark[]
}) => (
	<List.Section
		title={_.startCase(props.title)}
		subtitle={plural(props.filteredBookmarks.length, "bookmark")}
	>
